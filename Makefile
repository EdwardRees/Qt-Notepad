...
# Project:  notepad.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile notepad.pro
#############################################################################
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk -mmacosx-version-min=11 -Wall -Wextra -fPIC $(DEFINES)
...
DISTDIR = /Users/edwardrees/Projects/Qt\ Projects/notepad/.tmp/notepad1.0.0
...
EXPORT__PRO_FILE_ = /Users/edwardrees/Projects/Qt Projects/notepad/notepad.pro
...
notepad.app/Contents/MacOS/notepad: ui_notepad.h $(OBJECTS)  
	@test -d notepad.app/Contents/MacOS/ || mkdir -p notepad.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: notepad.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/macx.conf \
...
notepad.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,cs221.notepad,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},cs221.notepad,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},11,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,notepad,g" -e "s,@LIBRARY@,notepad,g" -e "s,\$${EXECUTABLE_NAME},notepad,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >notepad.app/Contents/Info.plist

all: Makefile \
		notepad.app/Contents/PkgInfo \
		notepad.app/Contents/Resources/empty.lproj \
		notepad.app/Contents/Info.plist notepad.app/Contents/MacOS/notepad
...
distdir: FORCE
	...
	$(COPY_FILE) --parents notepad.qrc $(DISTDIR)/
...
compiler_rcc_make_all: qrc_notepad.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_notepad.cpp
qrc_notepad.cpp: notepad.qrc \
		...
		images/save_as.png \
		images/cut.png
	/usr/local/share/qt/libexec/rcc -name notepad notepad.qrc -o qrc_notepad.cpp
...
moc_notepad.cpp: notepad.h \
	...
	/usr/local/share/qt/libexec/moc $(DEFINES) --include '/Users/edwardrees/Projects/Qt Projects/notepad/moc_predefs.h' -I/usr/local/share/qt/mkspecs/macx-clang -I'/Users/edwardrees/Projects/Qt Projects/notepad' -I/usr/local/lib/QtPrintSupport.framework/Headers -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/usr/local/lib notepad.h -o moc_notepad.cpp
...
ui_notepad.h: notepad.ui \
	...
	/usr/local/share/qt/libexec/uic notepad.ui -o ui_notepad.h
...
notepad.o: notepad.cpp /usr/local/lib/QtCore.framework/Headers/QFile \
		...
		/usr/local/lib/QtPrintSupport.framework/Headers/QPrintDialog \
		/usr/local/lib/QtPrintSupport.framework/Headers/qprintdialog.h \
		/usr/local/lib/QtPrintSupport.framework/Headers/QPrinter \
		...
		/usr/local/lib/QtWidgets.framework/Headers/QFontDialog \
...
qrc_notepad.o: qrc_notepad.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_notepad.o qrc_notepad.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/notepad/bin || mkdir -p $(INSTALL_ROOT)/opt/notepad/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/notepad/bin/notepad.app
	
	$(QINSTALL) notepad.app $(INSTALL_ROOT)/opt/notepad/bin/notepad.app
	-$(STRIP) $(INSTALL_ROOT)/opt/notepad/bin/notepad.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/notepad/bin/notepad.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/notepad/bin/ 
